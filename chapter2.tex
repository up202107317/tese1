...
Event-driven operation is not exclusive to Flash. The discrete-time level-crossing converter of Mou et al.\ \cite{mou2026} reaches excellent efficiency around a SAR-like structure, but it resolves each event through successive comparisons in a feedback loop, whereas a Flash bank resolves it in a single parallel step. For the low-latency, event-driven operation targeted here, that single-step conversion was the deciding argument in favour of Flash.
