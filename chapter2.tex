...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.7\textwidth]{figures/Current_mirror_comparator.pdf}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.7\textwidth]{figures/Hysteresis.pdf}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.7\textwidth]{figures/Min_Kim.pdf}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.7\textwidth]{figures/CCII.pdf}\\[2pt]
    \includegraphics[width=0.55\textwidth]{figures/CCII_opamp.pdf}
