...
\begin{description}
\item [SDG 7]
\textbf{Affordable and Clean Energy:} Ensure access to affordable, reliable, sustainable and modern energy for all. By optimising the power consumption of data converters, we extend the battery life of devices and reduce the overall energy footprint of IoT networks.
\item [SDG 9]
