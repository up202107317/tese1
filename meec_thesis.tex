...
\include{chapter2}
\include{chapter3}
\include{trimming}  % Chapter 4: Body Bias Trimming (continuação direta do Cap. 3)
\include{chapter4}  % Chapter 5: Synchronous Reference Flash ADC
\include{chapter5}  % Chapter 6: Simulation Results and Performance Benchmarking
