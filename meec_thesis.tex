...
\include{chapter1}
\include{chapter2}
\include{chapter4}  % Chapter 3: Synchronous Reference Flash ADC
\include{chapter3}  % Chapter 4: Proposed Asynchronous Flash ADC Design (com resultados por fase)
\include{trimming}  % Chapter 5: Body Bias Trimming
\include{chapter5}  % Chapter 6: Final Results and Comparison
\include{chapter6}  % Chapter 7: Conclusions
