...
It should be noted from the outset that the scope of this correction is
deterministic inter-corner variation: random intra-die mismatch, governed by
Pelgrom's law~\cite{pelgrom_1989}, is not addressed by the corner-indexed
table and is discussed as future work in Chapter~\ref{chap:Conclusions}.
...
with the dominant correction applied to the PMOS bulk. The resulting
