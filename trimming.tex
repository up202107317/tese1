...
$(V_{BN},\, V_{BP})$ was determined with the objective of bringing the DNL of
the converted thermometer code below $0.5$~LSB across the full input range;
the degree to which each corner meets that target is reported in
Chapter~\ref{chap:Benchmarking}. The pairs
