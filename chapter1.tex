...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.8\textwidth]{figures/OffsetErrorAndGainErrorExample_01.png} 
...
\caption[SNR versus sampling frequency for representative ADCs]{SNDR vs. Sampling Frequency (Flash reference [1] highlighted)}
\label{fig:snr_fs}
\end{figure}
The dependence of SNR on the sampling frequency for several state-of-the-art designs is presented in Fig.~\ref{fig:snr_fs}. By comparing the trajectories of different architectures, the figure shows how high-resolution sigma-delta converters sustain very high SNDR at low $f_s$, whereas Flash and SAR topologies occupy regions optimized for speed or moderate resolution.
\par\vspace{1.5em}
\par\vspace{1.5em}
\par\vspace{1.5em}
...
\begin{table}[htbp]
\centering
\caption{SNR vs. Sampling Frequency (Flash reference [1] highlighted)}
\label{tab:snr_fs}
\begin{tabular}{lllc}
\toprule
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.6\textwidth]{figures/LC_digital_logic.png}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.8\textwidth]{figures/resistive_ladder.png}
...
This professional toolset allows for precise transistor-level modeling and the verification of the offset trimming mechanism through analog and mixed-signal simulations. 
