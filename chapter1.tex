...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.8\textwidth]{figures/SigmaDelta.png} 
  \caption{Sigma-Delta ADC Architecture}
  \label{fig:sd_arch}
\end{figure}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.8\textwidth]{figures/DualSlope.png} 
  \caption{Dual-slope ADC Architecture.}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.8\textwidth]{figures/Power_comparison.png} 
