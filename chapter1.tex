...
Smart sensors are now everywhere, from wearable health monitors to distributed environmental and industrial nodes. The processing and storage of information are digital and have benefited from the scaling described by Moore's law, but the physical world is analog, temperature, sound and pressure are continuous in both time and amplitude. The Analog-to-Digital Converter (ADC) is the interface between the two domains, and every digital system that measures the real world depends on one \cite{johns_martin_2012}.
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.8\textwidth]{figures/irregular_breathing_sinusoidal_signal.pdf}
